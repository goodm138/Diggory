...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(Diggory.WIDTH, Diggory.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(Diggory.WIDTH, Diggory.HEIGHT);  
